...
def get_token_auth_header():
    """Attempt to get the header from the request and
    attempts to split bearer and the token

    Raises:
        AuthError: authorization_header_missing
        AuthError: invalid_header

    Returns:
        token (str): Token part of the header
    """
...
def check_permissions(permission, payload):
    ...
    Args:
        permission (str): string permission (i.e. 'get:schedule')
        payload (str): decoded jwt payload

    Raises:
        AuthError: invalid_claims
...
def requires_auth(permission=''):
    ...
    Args:
        permission (str, optional): Defaults to ''.
    """
